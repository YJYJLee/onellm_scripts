...
SAVE_DIR="$HOME/roofline_profile/seamless/baseline/S2TT"
mkdir -p $SAVE_DIR
...
SAVE_DIR="$HOME/roofline_profile/seamless/baseline/T2ST"
mkdir -p $SAVE_DIR
...
SAVE_DIR="$HOME/roofline_profile/seamless/baseline/T2TT"
mkdir -p $SAVE_DIR
